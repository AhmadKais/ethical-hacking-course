...
## 🎮 האתגר הגדול — Juice Shop CTF

> ל-OWASP Juice Shop יש **לוח ניקוד מוסתר** עם 100+ אתגרי פריצה. השלב הראשון: פשוט למצוא את לוח הניקוד עצמו (כבר אתגר!). משם — צוד דגלים.

  🏆 **אתגר:** מצא את ה-Scoreboard, ואז פתור לפחות 5 אתגרים (התחל מ-⭐). מי צובר הכי הרבה?
  ✅ הצלחה: פתרת אתגרי web אמיתיים עם ניקוד — החלק הכי כיף בקורס.

> 💡 גם בדפדפן: [**TryHackMe — OWASP Juice Shop**](https://tryhackme.com/room/owaspjuiceshop).
