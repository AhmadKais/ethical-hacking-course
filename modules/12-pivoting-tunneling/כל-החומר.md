...
## 🎮 האתגר הגדול — Wreath: חדור לרשת

> רשת של שלוש מכונות מאחורי מכונה חשופה אחת. תפרוץ, תפייבט, ותגיע לעומק — בדיוק כמו בבדיקה פנימית אמיתית.

[**TryHackMe — Wreath**](https://tryhackme.com/room/wreath) (רשת מלאה, מומלץ מאוד).
  🏆 **אתגר:** הגע למכונה הפנימית ה"מוסתרת" דרך ה-Pivot. צייר את דיאגרמת הרשת.
  ✅ הצלחה: חצית מרשת חשופה לרשת פנימית דרך מנהרה.
