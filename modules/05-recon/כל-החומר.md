...
## 🎮 האתגר הגדול — OhSINT: מצא הכול מתמונה אחת

> חדר ה-OSINT האגדי. נותנים לך **תמונה אחת** — וממנה אתה חושף שם, מיקום, שם משתמש וסיסמה. תרגיש כמו בלש דיגיטלי.

[**TryHackMe — OhSINT**](https://tryhackme.com/room/ohsint) (חינם, בדפדפן).
  🏆 **אתגר:** ענה על כל שאלות החדר. כמה פרטים חילצת מתמונה בודדת?
  ✅ הצלחה: הבנת כמה מידע דולף בלי ששמים לב — זה הלב של איסוף מידע.
