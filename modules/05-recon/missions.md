...
> - ☁️ **TryHackMe** (בדפדפן, ללא התקנה): [**Passive Reconnaissance**](https://tryhackme.com/room/passiverecon) · "Active Reconnaissance" · "OhSINT"
> - 🐧 **Kali (מקומי):** `theHarvester`, `sublist3r`, `whatweb`, Burp Suite — מותקנים ב-Kali.
