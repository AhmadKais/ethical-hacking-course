...
> - ☁️ **TryHackMe** (בדפדפן, ללא התקנה): [**Attacktive Directory**](https://tryhackme.com/room/attacktivedirectory) · "Attacking Kerberos" · "AD Basics"
> - 🐧 **Kali (מקומי):** מעבדת AD מקומית / **GOAD** — ⚠️ דורש 12GB+ RAM, לכן **הענן עדיף** כאן.
