...
> - ☁️ **TryHackMe** (בדפדפן, ללא התקנה): [**Buffer Overflow Prep**](https://tryhackme.com/room/bufferoverflowprep) (Tib3rius — הכי מומלץ)
> - 🐧 **Kali (מקומי):** **vulnserver** על מכונת **Windows** + **Immunity Debugger** + `mona.py`.
